 ...
 */
@Named(value = "staffManagementController")
@SessionScoped
public class StaffManagementController implements Serializable {
  ...
  /**
   * Creates a new instance of StaffManagementController
   */
  ...
  public void onInit(){
    newStaff = new User();
    staffList = staffFacade.findByRole(Constants.ROLE_MANAGEMENT_STAFF, SessionUtil.getUserId());
  }
  ...
  public void create(){
    if (newStaff != null) {
      ...
      newStaff.setRole(Constants.ROLE_MANAGEMENT_STAFF);
  ...
  private void refreshPage(){
    try {
      ...
      context.redirect(context.getRequestContextPath()+ "/management/management-staff");
    } catch (IOException e) {
