 ...
 */
@Named(value = "reservationStaffController")
@SessionScoped
public class ReservationStaffController implements Serializable {
  ...
  /**
   * Creates a new instance of ReservationStaffController
   */
  public ReservationStaffController() {
  }
  ...
  public void onInit(){
    newStaff = new User();
    staffList = staffFacade.findByRole(Constants.ROLE_RESERVATION_STAFF, SessionUtil.getUserId());
  }
  ...
  public void create(){
    if (newStaff != null) {
      ...
      newStaff.setRole(Constants.ROLE_RESERVATION_STAFF);
  ...
  private void refreshPage(){
    try {
      ...
      context.redirect(context.getRequestContextPath()+ "/management/reservation-staff");
    } catch (IOException e) {
